...
* version: 0.5.2
*
* @0.5.0更新: 修改添加新的曝光统计元素的方法，添加方法时可以添加元素的所有统计数据。
* @0.5.1更新：曝光统计的元素数据可以添加一个判断函数，满足判断函数时，才会发送统计。
* @0.5.2更新：修改获取元素距离页面顶部的高度的方法。
* @0.5.3跟新：添加constructor属性，指明对象所属的类型。
*/
