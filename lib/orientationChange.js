...
;(function (window) {
	...
	var orientationChange = {
		...
		destory : function () {
			...
			window.removeEventListener( 'orientationchange', that._excutionEvents, false);
			window.removeEventListener( 'resize', that._excutionEvents, false);
		...
		_addListener : function () {
			...
			window.addEventListener( 'orientationchange', that._executionOrientationchangeEvents, false);
			window.addEventListener( 'resize', that._excutionResizeEvents, false);
		}
	};
	...
	var exposureInterface = {
		isVertical : orientationChange.isVertical,
		isHorizontal : orientationChange.isHorizontal,
		on : orientationChange.on,
		off : orientationChange.off,
		destory : orientationChange.destory
	};
	window.orientationChange = exposureInterface;
})(window);
